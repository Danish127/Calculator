...
public class Calculator extends JFrame {
	...
	private BigDecimal register[] = {null, null};
        //track which register we're operating on
	private short index = 0;
        //default operator
	private char symbol = '\0';
        //keep track of whether there is a decimal point and where in the string it is
	...
	public static void main(String[] args) {
        ...
        //takes in two numbers and operator symbol
	private BigDecimal calculate(BigDecimal arg0, char symbol, BigDecimal arg1){
        ...
        //updates the text field based on inputs
	private void update(){
		if(register[0] == null) {
        ...
        //calculates the BigDecimal value of the strings.  Automatically switches registers
	private void modify(double num){
        ...
        //updates the symbol.  if an unfished calculation is in the bar, complete and update rgisters
